...
func TestCreateResolverSummary(t *testing.T) {
	fixture := []struct {
		input    metrics.MetricType
		resolver CollectorResolverSummary
	}{
		{metrics.Counter, resolveCounterSummary},
		{metrics.Gauge, resolveGaugeSummary},
		{metrics.Rate, resolveRateSummary},
		{metrics.Trend, resolveTrendSummary},
	}

	for _, v := range fixture {
		resolver := CreateResolverSummary(v.input)
...
func TestResolveCounterSummary(t *testing.T) {
	// Given
...
func TestResolveGaugeSummary(t *testing.T) {
	// Given
	metricName := "sample_metric"
	metricValue := 100.00
...
func TestResolveRateSummary(t *testing.T) {
	// Given
	metricName := "sample_metric"
...
func TestResolveTrendSummary(t *testing.T) {
	// Given
	metricName := "sample_metric"
	...
	// When
	collectors := resolveTrend(samples[0], "", "")
